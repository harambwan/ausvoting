...
if (new DateTime() > new DateTime("2017-09-25 02:00:00")) {
    $results_published = true;
} else {
    $results_publisher = false;
}
...
if ($_SESSION['voted'] == 'YES') {
    ...
    echo "<br><h2>VOTEDATA: </h2>", $_SESSION['datavote'], "<br>";
    echo "<h2>KEYDATA:</h2>", $_SESSION['datakey'], "<br>";
    echo "<h2>GRANT: </h2>", $_SESSION['replygrant'], "<br>";
    echo "<h2>VOTE: </h2>", $_SESSION['replypublishv'], "<br>";
    echo "<h2>KEY: </h2>", $_SESSION['replypublishk'], "<br>";
    echo "<h2>REVOKE: </h2>", $_SESSION['replyrevoke'];
